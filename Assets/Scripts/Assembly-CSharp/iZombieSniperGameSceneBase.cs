...
public class iZombieSniperGameSceneBase
{
	...
	public int AddNPC(int nID, Vector3 v3Pos, int nStartZone)
	{
		...
		switch ((NpcAiType)zombieBaseInfo.m_nAiType)
		{
		case NpcAiType.ZombieFool:
